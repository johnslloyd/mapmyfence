    ...
    <div className="max-w-2xl mx-auto p-4 md:p-8 space-y-6">
      ...
      <div className="bg-panel text-panel-foreground rounded-lg border border-border/50 shadow-sm p-4 md:p-6 space-y-6">
        ...
        <Alert>
          ...
          <AlertDescription>
            PostPlotter can't confirm your utility lines have been marked or that your project is
        ...
        <div className="space-y-3 pt-2 border-t">
          ...
          <p className="text-sm text-foreground/90">
            ...
            varies by city and county, and sometimes by HOA. PostPlotter doesn't know your local
